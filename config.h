...
static const char *tags[] = { "why", "bro", "jig", "hoe", "non" };
...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-e", "tmuxdd", NULL };
...
static Button buttons[] = {
	...
	{ ClkWinTitle,          0,              Button4,        setmfact,	{.f = -0.02} },
	{ ClkWinTitle,          0,              Button5,        setmfact,	{.f = +0.02} },
